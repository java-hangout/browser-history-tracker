...
public class MultiBrowserVisitedSitesTimeTracker_Optimized {
    ...
    private static List<String> getInstalledBrowsers() {
        ...
        //addBrowserIfExists(browsers, "ie", "C:\\Program Files\\Internet Explorer\\iexplore.exe");
        return browsers;
    }
    ...
    private static String getBrowserHistoryPath(String browserName, String userName) {
        ...
        switch (browserName.toLowerCase()) {
            ...
            case "ie":
                return getBrowserHistoryPathForIE(userHome, os);
            default:
                return null;
        }
    }
    ...
    private static String getBrowserHistoryPathForIE(String userHome, String os) {
        if (os.contains("win")) {
            return userHome + "\\AppData\\Local\\Microsoft\\Windows\\History\\History.IE5";
        }
        return null;
    }
