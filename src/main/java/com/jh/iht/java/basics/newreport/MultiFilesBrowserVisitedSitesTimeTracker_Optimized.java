...
public class MultiFilesBrowserVisitedSitesTimeTracker_Optimized {
    ...
    private static void generateVisitedSitesTimeTrackerRecord(String userName) {
        ...
        writeCsvToFile(csvFileName, csvData);
    }

    private static void writeCsvToFile(String filePath, List<String[]> data) {
    ...
    private static void writeJsonToFile(String filePath, JSONObject jsonReport) {
        System.out.println("Writing data into JSON file...");
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
